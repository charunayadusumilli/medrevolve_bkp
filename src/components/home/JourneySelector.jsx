...
const JOURNEYS = [
  ...
  },
  {
    key: 'ruo',
    icon: FlaskConical,
    title: 'RUO / Research Business',
    subtitle: 'Compliant RUO website with integrated marketing & support',
    description: 'Launch a compliant Research Use Only business with a done-for-you website, age-gated storefront, compliance controls, LegitScript certification pathway, and ongoing university training.',
    cta: 'Launch RUO Platform',
    ctaPath: 'MerchantOnboarding',
    demo: null,
    demoPath: null,
    color: '#991B1B',
