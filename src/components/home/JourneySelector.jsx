...
import {
  Stethoscope, FlaskConical, Building2, Pill, Megaphone,
...
const JOURNEYS = [
  {
    key: 'glp',
    icon: Stethoscope,
    title: 'GLP-1 & Telehealth',
    subtitle: 'Launch a physician-gated consumer wellness brand',
    description: 'Semaglutide, Tirzepatide, Hormones, NAD+. Telehealth infrastructure, licensed providers, and 503A/B pharmacy fulfillment — all under your brand.',
    cta: 'Start Your Platform',
    ctaPath: 'MerchantOnboarding',
    demo: 'See GLP Demo',
    demoPath: 'MerchantDemo',
    color: '#4A6741',
    bgLight: 'bg-[#4A6741]/10',
    borderActive: 'border-[#4A6741]',
    pill: 'Consumer Health',
    pillColor: 'bg-[#4A6741]/20 text-[#6B8F5E]',
  },
  {
    key: 'ruo',
    icon: FlaskConical,
    title: 'Research Compounds (RUO)',
    subtitle: 'Institutional peptide catalog with full compliance controls',
    description: 'BPC-157, TB-500, CJC-1295 and more. Age-gated, RUO-compliant storefronts with COA documentation, separate domain enforcement, and research-only language controls.',
    cta: 'Launch RUO Site',
    ctaPath: 'MerchantOnboarding',
    demo: 'See RUO Demo',
    demoPath: 'MerchantDemo',
  ...
  },
  {
    ...
    description: 'See 5-50 patients/week via telehealth. $40-80/consult or retainer model. Set your own schedule. E-prescribing, intake routing, and credentialing handled.',
  ...
  },
  {
    ...
    description: 'Receive a steady Rx referral stream from the MedRevolve network. Recurring monthly refills. LegitScript & NABP required. BAA + contract setup handled digitally.',
  ...
  },
  {
    key: 'creator',
    icon: Megaphone,
    title: 'Brand Building & Creators',
    subtitle: 'Monetize your wellness audience — 10–25% recurring commission',
    description: 'Earn 10-25% recurring commission on every patient you refer. Bronze → Silver → Gold → Platinum tiers. Monthly ACH payout. Real-time dashboard. 10K+ followers or active audience.',
