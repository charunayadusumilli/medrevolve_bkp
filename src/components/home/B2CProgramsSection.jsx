...
const PROGRAMS = [
  {
    ...
    whatYouGet: [
      'Initial physician consultation (telehealth)',
  ...
  },
  {
    ...
    color: '#2D6A9F',
    bgColor: '#0A1628',
    label: 'Men\'s Health & TRT',
    tagline: 'Testosterone & hormone optimization',
    description: 'A licensed physician evaluates your hormone levels, health history, and goals. If clinically appropriate, a tailored testosterone or hormone optimization program may be prescribed through our pharmacy network.',
    whatYouGet: [
      'Lab work review & health evaluation',
      'Physician consultation via telehealth',
      'Customized hormone protocol if appropriate',
      'Ongoing lab monitoring',
      'Provider follow-up included',
    ],
    disclaimer: 'Lab work may be required. Prescription required. Provider determines appropriateness.',
    cta: 'Talk to a Provider',
    ctaPath: 'BookAppointment',
  },
  {
    id: 'womens',
    ...
    color: '#B85C7A',
    bgColor: '#1A0A10',
    label: 'Women\'s Wellness & BHRT',
    tagline: 'Bioidentical hormone replacement therapy',
    description: 'Our licensed women\'s health providers evaluate your symptoms, labs, and health history to determine if bioidentical hormone replacement therapy or other wellness programs are appropriate for you.',
    whatYouGet: [
  ...
  },
  {
    ...
    tagline: 'Personalized physician-guided wellness programs',
    description: 'Our providers evaluate your wellness goals and health baseline to develop a personalized longevity and preventive health program including physician-supervised supplementation and lifestyle protocols.',
    whatYouGet: [
      'Comprehensive wellness evaluation',
      'Personalized health optimization plan',
      'Physician-supervised supplement protocols',
      'Quarterly health reviews',
      'Ongoing provider access',
    ],
    disclaimer: 'All programs physician-supervised. Individual results may vary.',
    cta: 'Get Evaluated',
    ctaPath: 'BookAppointment',
  },
];
