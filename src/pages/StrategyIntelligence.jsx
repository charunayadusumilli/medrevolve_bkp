...
const ACTION_ITEMS = [
  ...
  { priority: 'critical', area: 'Website', task: 'Remove all FDA-banned compounds (BPC-157 reference on GLP sites, bacteriostatic water with syringes)', owner: 'Dev', status: 'todo', deadline: 'Immediate' },
  { priority: 'critical', area: 'Website', task: 'Add proper disclaimers: "For research use only, not for human or veterinary use" + age gate + Terms/Privacy/Refund policy', owner: 'Dev', status: 'in_progress', deadline: 'Week 1' },
  ...
  { priority: 'high', area: 'Product', task: 'Launch Bacteriostatic Water only site (separate domain — NOT on medrevolve.com)', owner: 'Dev', status: 'todo', deadline: 'Week 2' },
