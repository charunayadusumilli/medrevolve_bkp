...
const allProducts = [
  ...
  },
  {
    ...
    form: 'Injectable Vial',
    promise: 'Deep recovery, muscle repair, and anti-aging benefits.',
    lifestyle: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=90',
    productBg: 'bg-[#EEEEF5]',
    tag: 'Recovery',
    tagColor: 'bg-[#3D3680]',
    ...
    customers: '4,800+',
    rx: true,
    benefits: ['Stimulates natural GH release', 'Improves sleep quality & recovery', 'Supports lean muscle growth', 'Compounded at licensed pharmacy'],
    description: 'Ipamorelin + CJC-1295 is a physician-prescribed peptide combination that stimulates the pituitary gland to naturally release growth hormone — supporting recovery, body composition, and longevity goals.',
  },
  {
    id: 8,
    name: 'NAD+ Injection',
